...
class Sanic:
    ...
    def loop(self):
        ...
        Only supported when using the `sanic.run` method.
        """
        if not self.is_running and self.asgi is False:
            raise SanicException(
                "Loop can only be retrieved after the sanic has started "
    ...
    def register_listener(self, listener, event):
        ...
        Args:
            listener: callable i.e. setup_db(sanic, loop)
    ...
    def remove_route(self, uri, clean_cache=True, host=None):
        """
        This method provides the sanic user a mechanism by which an already
        ...
        :param uri: URL Path to be removed from the sanic
    ...
    def register_middleware(self, middleware, attach_to="request"):
        ...
        decorator provided at the sanic level.
    ...
    def middleware(self, middleware_or_request):
        ...
        Can either be called as *@sanic.middleware* or
    ...
    def run(
        ...
        **kwargs: Any
        ...
        :param stop_event: event to be triggered
            before stopping the sanic - deprecated
    ...
    async def create_server(
        ...
        before starting the *sanic* sanic in Async mode.
