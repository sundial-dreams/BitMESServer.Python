...
class Blueprint:
    ...
    def register(self, app, options):
        """
        Register the blueprint to the sanic sanic.

        :param app: Instance of :class:`sanic.sanic.Sanic` class
        :param options: Options to be used while registering the
            blueprint into the sanic.
    ...
    def get(
        ...
        :param strict_slashes: Instruct :class:`sanic.sanic.Sanic` to check
